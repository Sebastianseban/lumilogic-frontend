...
export default function BenefitsGridBlock({ data }) {
  ...
  const sectionDescription = data?.description || data?.subheading;
    ...
    <section className="py-20 px-6 bg-[#020617]"> {/* section-padding */}
      <div className="container mx-auto">
        ...
        <p className="text-center text-[#94a3b8] max-w-2xl mx-auto mb-12">
          {sectionDescription || "We follow a structured and proven methodology to ensure smooth transitions with minimal risk."}
        </p>
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="text-[2rem] font-bold text-[#CE80DD] opacity-50 font-inter">
